...
//TO DO : neaten, add to a set specifically, url for email...
//get it not to go to your page
//have it say mroe infor in the email, like the link and the date
//so threfore you have to access the posttoweb java library
//add to imageset on flickr
//still capture video and post online
